...
class regressor(nn.Module):
    def __init__(self, num_classes):
        super().__init__()
        # self.regressor = nn.Sequential(nn.LazyLinear(num_classes), nn.ReLU(),
        #                                     nn.LazyLinear(num_classes // 2), nn.ReLU(),
        #                                     nn.LazyLinear(num_classes // 4), nn.ReLU(),
        #                                     nn.LazyLinear(num_classes // 8), nn.ReLU(),
        #                                     nn.LazyLinear(num_classes // 16), nn.ReLU(),
        #                                     nn.LazyLinear(num_classes // 32), nn.ReLU(),
        #                                     nn.LazyLinear(3))

        self.regressor = nn.Sequential(nn.LazyLinear(3))
...
class AnyNet_L_reg(nn.Module):
    ...
    def __init__(self, arch, stem_channels, frequency_bin, num_classes):
        super().__init__()
        ...
        self.net.add_module('head', nn.Sequential(nn.AdaptiveAvgPool2d((1, 1)), nn.Flatten(), self.regressor(num_classes)))
...
class ViT_L_reg(nn.Module):
    def __init__(self, frequency_bin, img_size, patch_size, num_hiddens, mlp_num_hiddens,
        ...
        self.head = nn.Sequential(nn.LayerNorm(num_hiddens), regressor(num_classes))
...
class RNN_L_reg(nn.Module):
    def __init__(self, frequency_bin, RNN_args):
        ...
        self.FC = nn.Sequential(
            ...
            self.regressor(RNN_args['category_num']),
        )
